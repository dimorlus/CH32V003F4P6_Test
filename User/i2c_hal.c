...
/**
  ...
  * @retval HAL status
  */
uint8_t HAL_I2C_Transmit(I2C_TypeDef *i2c_periph, uint8_t DevAddress, uint8_t *pData, uint16_t Size,
...
/**
  ...
  * @retval HAL status
  */
uint8_t HAL_I2C_Receive(I2C_TypeDef *i2c_periph, uint8_t DevAddress, uint8_t *pData, uint16_t Size,
  uint32_t i2c_timeout)
 {
  uint32_t tickstart = get_tick();
  uint16_t count = Size;
...
/**
  ...
  * @retval HAL status
  */
uint8_t HAL_I2C_Mem_Write(I2C_TypeDef *i2c_periph, uint8_t DevAddress, uint8_t MemAddress,
  const uint8_t *pData, uint16_t Size, uint32_t i2c_timeout)
 {
  uint32_t tickstart = get_tick();
  uint16_t count = Size;
...
/**
  ...
  * @retval HAL status
  */
uint8_t HAL_I2C_Mem_Read(I2C_TypeDef *i2c_periph, uint8_t DevAddress, uint8_t MemAddress,
  uint8_t *pData, uint16_t Size, uint32_t i2c_timeout)
 {
  uint32_t tickstart = get_tick();
  uint16_t count = Size;
  /* i2c master sends start signal only when the bus is idle */
